...
public:
	...
	Art(int width, int height) : m_layers()
	{
		if (width > 0 && height > 0)
		{
	...
	// Copy constructor
	Art(const Art& other_art) : m_layers(other_art.m_layers)
	{}
...
private:
	...
	// Function determines whether a string contains only spaces (used in unpad() above)
