...
// Default constructor
Game::Game() : m_dealer(6), m_player(), m_input(), m_stage(plrChoice), m_zoom(false), m_tot_bought(0)
{}
...
void Game::set_input(Stage stage)
{
	switch (stage)
	{
	case plrChoice:
...
function<bool(string)> Game::in_intvl(int min, int max)
{
	return
